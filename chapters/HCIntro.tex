...
e.g. An air pressure test result of \SI{5}{\cubic\metre\per\square\metre\per\hour} at \SI{50}{\pascal} would result in an air infiltration rate of approximately 0.111 ACH at atmospheric conditions.
...
\begin{itemize}
\item Calculate Conduction (Fabric) Heat Gain,
\item Calculate Solar Heat Gain (Transparent and Opaque),
\item Calculate Infiltration Heat Gain,
\item Calculate Ventilation System Heat Gain (If Applicable),
\item Allow for Local Effects,
\item Calculate Peak Cooling Load,
\item Size/Select Cooling Units,
\item Calculate Distribution System Heat Gain,
\item Determine Infiltration Diversity Ratio,
\item Calculate Central Plant Size,
\item Select Central Plant, including any redundancy.
\end{itemize}

\subsection{Conduction (Fabric) Heat Gain}



\subsection{Solar Heat Gain}



\subsubsection{Transparent Solar Heat Gain}



\subsubsection{Opaque Solar Heat Gain}



\subsection{Infiltration Heat Gain}