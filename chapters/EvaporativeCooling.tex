...
As we know this is not the case, an efficiency ratio \[\eta\] can be added to the equation to give the out temperature and reference the wet bulb to the starting temperature:

\[\Theta_{B} = \eta (\Theta_{A} - \Theta_{WB})\]
