...
\usepackage[toc,nonumberlist,acronym,automake]{glossaries}
%Glossaries package for the control of glossary and acronym entries,
%with the options to include the glossary in the T.O.C., not include a number list,
%use the acronym package and automatically make the glossary.
